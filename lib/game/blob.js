...
Blob.images = {
    player  : 'assets/yellow.png',
    smaller : 'assets/blue.png',
    bigger  : 'assets/red.png'
};

Blob.highlight = Blob.getImage('assets/blue_highlight.png');
...
Blob.prototype.render = function(ctx, playerBlob) {
    ...
    var img = this.getBlobImage('images', playerBlob),
        highlight = this.constructor.highlight;
